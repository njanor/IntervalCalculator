...
public class IntervalInterpreterTest {
    ...
    public void interpretString_WithNoIntervals_ReturnsEmptyList() {
        List<Interval> interpretedIntervals = IntervalInterpreter.interpretIntervalsFromString("");
    ...
    public void interpretString_WithSingleInterval_ReturnsListWithOneInterval() {
        ...
        List<Interval> interpretedIntervals = IntervalInterpreter.interpretIntervalsFromString(lowerBound + "-" + upperBound);
    ...
    public void interpretString_WithMultipleIntervals_ReturnsListWithAllIntervals() {
        ...
        List<Interval> interpretedIntervals = IntervalInterpreter.interpretIntervalsFromString(input);
