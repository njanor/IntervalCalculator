...
public class IntervalInterpreterTest {
    ...
    public void interpretString_WithNoIntervals_ReturnsEmptyList() {
        List<ConcreteInterval> interpretedIntervals = IntervalInterpreter.interpretIntervals("()");
    ...
    public void interpretString_WithSingleInterval_ReturnsListWithOneInterval() {
        ...
        List<ConcreteInterval> interpretedIntervals = IntervalInterpreter.interpretIntervals("(" + lowerBound + "-" + upperBound + ")");
